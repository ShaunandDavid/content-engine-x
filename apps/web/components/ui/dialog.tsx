...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-[min(100%-2rem,36rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-[28px] border border-border bg-background p-6 shadow-[0_30px_80px_rgba(0,0,0,0.18)]",
        className
      )}
      {...props}
    >
